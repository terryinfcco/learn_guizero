...
def tick():
    ...
    minutes_left = 29 - elapsed_seconds // 60
...
clock = Text(app, size=55, bg="white", text="Time Left: " + time.strftime("%H:%M:%S"), width="fill", height=2)
timer = Text(app, size=55, bg="green", text="30:00", width="fill", height=2)
start_sec = int(time.time())
button_bg = "#D3D3D3"
